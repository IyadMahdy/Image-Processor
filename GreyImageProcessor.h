...
*/
#ifndef IMAGE_PROCESSOR_GREYIMAGEPROCESSOR_H
#define IMAGE_PROCESSOR_GREYIMAGEPROCESSOR_H

#include "Image.h"

class GreyImageProcessor : public Image {
private:
...
#endif //IMAGE_PROCESSOR_GREYIMAGEPROCESSOR_H
